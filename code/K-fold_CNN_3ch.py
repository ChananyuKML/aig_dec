...
# ----- Load Dataset -----
test_dir = '../datasets/real-fake_faces/test'
...
for fold, (train_idx, val_idx) in enumerate(kf.split(indices)):
    ...
    model.load_state_dict(torch.load("../checkpoints/HoG_CNN_3ch/ckpt_29.pth", map_location=device))
    model.eval()
...
plt.legend()
plt.tight_layout()
plt.savefig("kfold_CNN_3ch.png")
print("📊 Saved as 'kfold_CNN_3ch.png'")
plt.show()