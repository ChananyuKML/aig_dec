...
def train_model(model, train_loader, valid_loader, batch_size=32, num_epochs=10, lr=1e-4, device='cpu'):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'../checkpoints/res18_hog/ckpt_{epoch+1}.pth')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('loss_curve_hog.png')  # Save the plot
plt.show()
# torch.save(model.state_dict(), f'../checkpoints/res18_hog/ckpt_{num_epochs}.pt')